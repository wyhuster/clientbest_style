...
<!--<a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>-->
  <ul>
    <li><a href="/clientbest/web/index.php"><i class="icon icon-home"></i> <span>Index</span></a> </li>
    ...
    <li class="active"><a href="/clientbest/web/st_history/history.php"><i class="icon icon-fullscreen"></i> <span>使用记录</span></a></li>
